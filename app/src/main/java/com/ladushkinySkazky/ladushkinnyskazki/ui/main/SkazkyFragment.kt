...
class SkazkyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.d("POSCAT", "position = $position")
    ...
    private fun updateAdapter(list : ArrayList<CategorySkazkiModel>, skazkiAdapter: SkazkiAdapter, progress: ProgressBar, position: Int) {
